                   ...
                   float ax, float ay, float az)
{
    ...
    f->acc_norm = sqrtf(ax*ax + ay*ay + az*az);
 ...
 */
__attribute__((section(".ccmram"))) static inline float32_t arm_invSqrt(float32_t x) {
    float32_t out;
 ...
 * @return void
 */
__attribute__((section(".ccmram"))) void RotationMatrix_update(struct MAHONY_FILTER_t *f)
{
 ...
 * @return void
 */
__attribute__((section(".ccmram"))) void mahony_update(struct MAHONY_FILTER_t *f,
                   float gx, float gy, float gz,
                   float ax, float ay, float az)
{
    gx *= DEG2RAD;
